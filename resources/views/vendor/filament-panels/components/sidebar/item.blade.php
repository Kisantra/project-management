...
>
    ...
    {{-- Published override (Filament 3.3.18): child items are always listed, not only while
         the parent is the active section. Used by the per-department sub-menu under Projects.
         Diff against vendor/filament/filament/resources/views/components/sidebar/item.blade.php
         when upgrading Filament. --}}
    @if ($childItems)
